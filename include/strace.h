...
void print_register(char *name, int nb_args, unsigned int reg, strace_info_s *strace, int type);
void print_all_register(char *name, int count, struct user_regs_struct u_in, strace_info_s *strace);
void display_registers(unsigned sysnum, unsigned retval, struct user_regs_struct u_in, strace_info_s *strace);
int create_pid(int ac, char **av, char **envp);
int error_syscall(struct user_regs_struct u_in, strace_info_s *strace);
int check_ptrace( struct user_regs_struct u_in, strace_info_s *strace);
void error_registers(struct user_regs_struct u_in, strace_info_s *strace);
